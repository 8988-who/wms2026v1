 ...
 * AGV 物料绑定接口请求 DTO
 * <p>
 * 对应 RCS 接口 {@code POST /rcs/rtas/api/robot/controller/matlabel/bind}（ApiEnum.AGV_bindMatlabel）。
 * 将物料标签绑定到载具（货架）上，仅支持货架绑定物料，且空闲状态的货架才能绑定。
 ...
 * @since 2026-08-10
 */
@Schema(description = "AGV物料绑定接口请求参数")
@Getter
@Setter
public class AgvBindMatlabelDTO extends AgvRequestDTO {
