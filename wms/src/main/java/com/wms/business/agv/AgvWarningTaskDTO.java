...
//
// /**
//  * AGV 任务异常告警上报接口 DTO（SPI，RCS→WMS）
//  * <p>
//  * 对应接口 {@code POST /api/robot/reporter/task/warning}（ApiEnum.AGV_warningTask）。
//  * RCS 将任务运行中的严重告警推送给 WMS（只推送一次）。
...
//  * @since 2026-08-10
//  */
// @Schema(description = "AGV任务异常告警上报接口参数（SPI）")
// @Getter
// @Setter
// public class AgvWarningTaskDTO extends AgvRequestDTO {
//
//     private static final long serialVersionUID = 1L;
//
//     @Schema(description = "异常任务编号")
